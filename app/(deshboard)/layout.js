        ...
        <div className="h-screen text-black">
            ...
            <div className="">
                <div className={`fixed bg-white border-r border-gray-200 w-[250px] h-screen px-3 py-4 ${isSideberOpen ? "block lg:block" : "hidden lg:block"}`}>
                    ...
                    <div onClick={() => { setisSideberOpen(false) }} className={`absolute w-[25px] h-[25px] right-0 top-0 bg-sky-300 rounded-sm cursor-pointer text-white flex lg:hidden items-center justify-center`}>
                        <RxCross2 className="" />
                    </div>
