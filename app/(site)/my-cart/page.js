...
const resolveImageSrc = (image) => {
  if (!image || typeof image !== 'string') return '/placeholder-product.jpg';
                ...
                <div className="grid grid-cols-12 gap-6">
                    ...
                    <div className="col-span-12 lg:col-span-4 bg-white rounded-xl shadow-md p-6 flex flex-col justify-between">
                        <div>
                            ...
                            <div className="bg-red-50 border border-red-200 p-3 rounded-md mb-6 flex items-center gap-2">
                                <ImNotification className='text-5xl text-red-300' />
                                <span className='text-gray-500'>
                                    <b className="text-red-300">Important:</b> After successful Order, We will contact you very soon.
                                </span>
                            </div>
