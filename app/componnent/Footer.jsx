    ...
    return (
        <footer className="bg-white border-0 border-t border-gray-200 h-fit z-20 relative">
            ...
            <div className="bg-sky-500 text-lg text-center text-white py-2 z-20">
                © 2025 Momento Cards. All Rights Reserved ||  Develop by<Link className="cursor-pointer text-red-300 z-20" target="blank" href={'https://sardaritbd.com'}> Sardar IT</Link>
            </div>
        </footer>
    )
}
