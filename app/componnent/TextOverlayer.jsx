...
export const BackOne = ({ cardti, carddes, name, name2, name3, acarddate }) => {
    return (
        <div className="w-full h-full relative">
            ...
            <span className="text-white text-[8px] lg:text-xs AileronFont tracking-wider font-thin absolute top-17 lg:top-26 left-11 lg:left-15 line-clamp-3 text-center w-[160px] lg:w-[270px] z-50">{carddes}</span>
            ...
            <span className="text-white text-[8px] lg:text-xs AileronFont tracking-wider font-thin absolute top-36.5 left-10 lg:top-57 lg:left-15 line-clamp-4 text-center w-[170px] lg:w-[270px] z-50">{name2}</span>
            ...
            <span className="text-white text-[8px] lg:text-xs AileronFont tracking-wider font-thin absolute top-63 left-10 lg:top-96 lg:left-15 line-clamp-4 text-center w-[170px] lg:w-[270px] z-50">{acarddate}</span>
