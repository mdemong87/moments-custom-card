...
const Customzaizer = () => {
    ...
    const imgss = isDeck ? "/customaizerDeck.png" : "/customaization trading.png";
            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid md:grid-cols-1 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <div className="order-1 md:order-1 relative h-fit rounded-2xl overflow-hidden bg-sky-400/10 flex items-center justify-center">
                            <Image className="w-full object-contain border-3 border-sky-400/10 rounded-2xl" src={imgss} width={1000} height={1000} alt='what is momento' />
                        </div>
                    </div>
                </div>
            </div>
